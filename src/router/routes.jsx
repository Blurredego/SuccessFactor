...
const ManualLeads = lazy(() => import('../pages/OnBoarding/Leads/ManualLeads/ManualLeads'));
...
const routes = [
    ...
    {
        path: '/data-tables/skin',
        element: <Skin />,
    },
    {
        path: '/data-tables/order-sorting',
        element: <OrderSorting />,
    },
    {
        path: '/data-tables/multi-column',
        element: <MultiColumn />,
    },
    {
        path: '/data-tables/multiple-tables',
        element: <MultipleTables />,
    },
    {
        path: '/data-tables/alt-pagination',
        element: <AltPagination />,
    },
    {
        path: '/data-tables/checkbox',
        element: <Checkbox />,
    },
    {
        path: '/data-tables/range-search',
        element: <RangeSearch />,
    },
    {
        path: '/data-tables/export',
        element: <Export />,
    },
    {
        path: '/data-tables/column-chooser',
    ...
    // authentication
    {
        path: '/authentication/login-boxed',
        element: <LoginBoxed />,
    },
    {
        path: '/authentication/register-boxed',
        element: <RegisterBoxed />,
    },
    {
        path: '/authentication/unlock-boxed',
        element: <UnlockBoxed />,
    },
    {
        path: '/authentication/recover-id-boxed',
    ...
    {
        path: '/authentication/recover-id-cover',
        element: <RecoverIdCover />,
    },
    {
        path: '/authentication/unlock-cover',
        element: <UnlockCover />,
    },
    {
        path: '/error',
    ...
    {
        path: '/forms/file-upload-preview',
