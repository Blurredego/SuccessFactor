...
const Basic = () => {
    ...
    useEffect(() => {
        dispatch(setPageTitle('Google Leads'));
    });
        ...
        <div className="space-y-6">
            <div className="panel">
                <div className="flex items-center justify-between mb-5">
                    <div>
                        <h2 className="text-xl font-bold">Google Leads</h2>
                    </div>
                ...
                <div className="datatables">
                    <DataTable
                        ...
                        columns={[
                            ...
                            { accessor: 'company', title: 'City' },
                            { accessor: 'phone', title: 'Phone No' },
                            { accessor: 'company', title: 'Current Qualification' },
                            { accessor: 'company', title: 'Current Institute' },
                            { accessor: 'company', title: 'Desired University' },
                            { accessor: 'company', title: 'Admission Intake' },
                            { accessor: 'company', title: 'Specefic Query' },
