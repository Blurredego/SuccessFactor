...
import LeadStatusModal from '../OnBoarding/Leads/ManualLeads/LeadStatusModal';
    ...
    const rowData = [
        {
            ...
            actions: <div className="dropdown flex justify-center">
                <Dropdown offset={[0, 5]} placement={`${isRtl ? 'bottom-start' : 'bottom-end'}`} button={<IconHorizontalDots className="opacity-70 m-auto" />}>
                    <ul>
                        <li>
                            <button type="button" onClick={() => setModal4(true)}>View Lead</button>
                        </li>
                        <li>
                            <button type="button" onClick={() => setModal3(true)}>Edit Lead</button>
                        </li>
                        <li>
                            <button type="button" onClick={() => setModal2(true)}>Lead Status</button>
                        </li>
                        <li>
                            <button type="button">Lead Score</button>
                        </li>
                        <li>
                            <button type="button">Delete Lead</button>
                        </li>
                        <li>
                            <button type="button">Lead Campaign</button>
                        </li>
                        <li>
                            <button type="button">Add Collaborator</button>
                        </li>
                        <li>
                            <button type="button" onClick={() => setModal5(true)}>Proceed to Query</button>
                        </li>
                    </ul>
                </Dropdown>
            </div>
                                            ...
                                            <div className="mb-5">
                                                <form>
                                                    <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-2 mb-5">
                                                        <Select options={branchesOptions} isSearchable={true} placeholder="Branch" className='lg:col-span-2' styles={customStyles} />
                                                    ...
                                                    <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-2 mb-5">
                                                        <div className="flex lg:col-span-2">
                                                            <Flatpickr value={date1} options={{ dateFormat: 'Y-m-d', position: isRtl ? 'auto right' : 'auto left' }} className="form-input" onChange={(date) => setDate1(date)} placeholder='Date of Birth' />
                                                        </div>
