...
const Analytics = () => {
    ...
    useEffect(() => {
        dispatch(setPageTitle('Query Report'));
    });
            ...
            <div className="flex flex-col xl:flex-row gap-5 relative">
                ...
                <div className="panel p-0 flex-1">
                    <div className="md:flex items-center flex-wrap p-4 border-b border-[#ebedf2] dark:border-[#191e3a]">
                        ...
                        <ul className=" rtl:md:mr-auto grid grid-cols-2 sm:grid-cols-3 font-semibold sm:divide-x rtl:divide-x-reverse divide-[#ebedf2] dark:divide-[#253b5c] text-white-dark mt-5 sm:mt-0">
