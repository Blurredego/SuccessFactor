...
const MultipleTables = () => {
    ...
    const [recordsData2, setRecordsData2] = useState(rowData);
    ...
    useEffect(() => {
        ...
        setRecordsData2([...recordsData2.slice(from, to)]);
    }, [page2, pageSize2, recordsData2]);
    ...
    return (
        <>
            <div className="panel">
                <div className="flex md:items-center md:flex-row flex-col justify-between mb-5 gap-5">
                ...
                <div className="datatables">
                    <DataTable
                        ...
                        columns={[
                            ...
                            { accessor: 'company', title: 'User Role' },
                            {
                                accessor: 'action',
                                title: 'Actions',
                        ...
                        totalRecords={recordsData2.length}
